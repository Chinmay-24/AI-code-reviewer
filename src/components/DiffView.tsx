    ...
    <div className="space-y-4">
      <div className="grid grid-cols-1 gap-4">
        ...
        <div>
          ...
          <div className="bg-gradient-to-br from-slate-50 to-slate-50/50 rounded-lg border border-slate-250 p-4 overflow-x-auto shadow-sm">
          ...
          <div>
            ...
            <div className="space-y-2.5">
              {suggestions.map((suggestion, i) => (
                <div key={i} className="bg-gradient-to-br from-amber-50 to-amber-50/50 border border-amber-250 rounded-lg p-4 shadow-sm hover:shadow-md transition-all">
